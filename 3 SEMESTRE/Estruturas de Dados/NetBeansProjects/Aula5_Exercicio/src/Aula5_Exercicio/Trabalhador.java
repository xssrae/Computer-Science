...
class Trabalhador { //Decidi implementar a  classe main na classe trabalhador pois prefiri inserir todos os métodos dde visualização separados dos de ordenação.
